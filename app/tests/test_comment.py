...
class CommentModelTest(unittest.TestCase):
    def setUp(self):
        self.user_anne = User(username = 'ted',password = '123isshort', email = 'ted@gmail.com')
        self.new_blog = Blog(id=1,blog_title='Music',blog_content='music is life',user = self.user_anne)
